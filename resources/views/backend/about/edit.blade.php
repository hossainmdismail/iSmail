        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <form class="theme-form theme-form-2 mega-form" action="{{ route('about.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $data->id }}">
                        <div class="mb-4 row align-items-center">
                            <label class="form-label-title col-sm-3 mb-0">Title</label>
                            <div class="col-sm-9">
                                <input class="form-control @error('title') is-invalid @enderror" type="text" placeholder="Title" name="title" value="{{ $data->title }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            <img style="width: 150px" src="{{ asset('uploads/about') }}/{{ $data->image }}" alt="Profile">
                        </div>
                        <div class="mb-4 row align-items-center">
                            <div class="mb-4 row align-items-center">
