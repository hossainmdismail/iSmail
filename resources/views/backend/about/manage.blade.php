            ...
            <div class="card-body">
                <div class="title-header option-title">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ route('about.link') }}" class="align-items-center btn btn-theme">
                    ...
                    <table class="table all-package theme-table dataTable no-footer" id="table_id" aria-describedby="table_id_info">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td class="sorting_1">{{ $datas->title }}</td>

                                <td>{{Str::substr($datas->description, 0, 20)  }} ...</td>

                                <td>{{Str::substr($datas->link, 0, 20)  }} ...</td>
                                <td>
                                    <div class="table-image">
                                        <img src="{{ asset('uploads/about') }}/{{ $datas->image }}" class="img-fluid" alt="">
                                    </div>
                                </td>
                                ...
                                <td>
                                    <ul>
                                        <li>
                                            <a href="{{ route('about.edit',$datas->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('about.delete',$datas->id) }}" class="btn btn-animation btn-md fw-bold">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
