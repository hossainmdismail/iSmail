            ...
            <div class="card-body">
                <div class="title-header option-title">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ route('skills.link') }}" class="align-items-center btn btn-theme">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td>
                                    <ul>
                                        <li>
                                            <a href="{{ route('skills.edit',$datas->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('skills.delete',$datas->id) }}" class="btn btn-animation btn-md fw-bold">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
