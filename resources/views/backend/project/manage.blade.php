            ...
            <div class="card-body">
                <div class="title-header option-title">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ route('project.link') }}" class="align-items-center btn btn-theme">
                    ...
                    <table class="table all-package theme-table dataTable no-footer" id="table_id" aria-describedby="table_id_info">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td class="sorting_1">
                                    <img style="width: 50px;margin:10px" src="{{ asset('uploads/project') }}/{{ $datas->photo }}" class="img-fluid" alt="">
                                    <img style="width: 50px;margin:10px" src="{{ asset('uploads/project') }}/{{ $datas->thumbnail }}" class="img-fluid" alt="">
                                </td>

                                <td>{{$datas->rel_to_cat->name}}</td>
                                <td>{{Str::substr($datas->title, 0, 20)  }} ...</td>

                                <td>
                                    {{ $datas->startingDate->format('Y') }} to {{ ($datas->endDate == null? 'Working':$datas->endDate->format('Y')) }}
                                </td>
                                <td>
                                @if ($datas->status == 0)
                                ...
                                <td>
                                    <ul>
                                        <li>
                                            <a href="{{ route('project.edit',$datas->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('project.delete',$datas->id) }}" class="btn btn-animation btn-md fw-bold">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
