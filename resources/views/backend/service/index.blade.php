    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card-body">
                    <form class="theme-form theme-form-2 mega-form" action="{{ route('service.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control @error('offerTitle') is-invalid @enderror" type="text" placeholder="Offer Title" name="offerTitle" value="{{ old('offerTitle') }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control @error('offerDescription') is-invalid @enderror" type="text" placeholder="Description" name="offerDescription">{{ old('offerDescription') }}</textarea>
                            </div>
                        </div>
