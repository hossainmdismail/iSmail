            ...
            <div class="card-body">
                <div class="title-header option-title">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ route('service.link') }}" class="align-items-center btn btn-theme">
                    ...
                    <table class="table all-package theme-table dataTable no-footer" id="table_id" aria-describedby="table_id_info">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td>{{Str::substr($datas->offerDescription, 0, 50)  }}...</td>
                                ...
                                <td>
                                    <ul>
                                        <li>
                                            <a href="{{ route('service.edit',$datas->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('service.delete',$datas->id) }}" class="btn btn-animation btn-md fw-bold">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
