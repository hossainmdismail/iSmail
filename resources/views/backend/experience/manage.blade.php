            ...
            <div class="card-body">
                <div class="title-header option-title">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ route('experience.link') }}" class="align-items-center btn btn-theme">
                    ...
                    <table class="table all-package theme-table dataTable no-footer" id="table_id" aria-describedby="table_id_info">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td class="sorting_1"><img style="width: 50px;margin:10px" src="{{ asset('uploads/experience') }}/{{ $datas->logo }}" class="img-fluid" alt="">{{ $datas->name }}</td>

                                <td>{{$datas->title}}</td>
                                <td>{{Str::substr($datas->description, 0, 20)  }} ...</td>
                                ...
                                <td>
                                    <ul>
                                        <li>
                                            <a href="{{ route('experience.edit',$datas->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('experience.delete',$datas->id) }}" class="btn btn-animation btn-md fw-bold">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
