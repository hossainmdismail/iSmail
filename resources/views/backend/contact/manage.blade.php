            ...
            <div class="card-body">
                <div class="title-header option-title">
                    ...
                    <form class="d-inline-flex">
                        <a href="{{ route('contact.link') }}" class="align-items-center btn btn-theme">
                    ...
                    <table class="table all-package theme-table dataTable no-footer" id="table_id" aria-describedby="table_id_info">
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td class="sorting_1">
                                    <i class="{{ $datas->icon }}" style="font-size: 22px;padding: 10px;"></i>
                                    {{ $datas->title }}</td>
                                ...
                                @else
                                <span class="badge bg-primary">Actived</span> <br>
                                @endif
                                </td>
                                <td>
                                    <ul>
                                        <li>
                                            <a href="{{ route('contact.edit',$datas->id) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('contact.delete',$datas->id) }}" class="btn btn-animation btn-md fw-bold">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        @empty
                        <span class="text-secondary ">No Data Fount ! <a href="{{ route('contact.link') }}">Add New</a> </span>
                        @endforelse
                        </tbody>
                    </table>
                </div>
